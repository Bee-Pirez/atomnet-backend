...
export const locale: Locale = {
  ...
  translations: {
    ...
    labels: {
      ...
      form_submissions: 'Formulários Enviados',
      answers: 'Respostas Enviadas',
      question_categories: 'Categorias de Perguntas',
      forms: 'Formulários',
      questions: 'Perguntas dos Formulários',
      users: 'Usuários'
    },
    properties: {
      ...
      questionCategoryId: 'ID da Categoria',

      sendDate: 'Data de Envio',

      userId: 'ID do Usuário',

      isApplicable: 'É aplicável',

      formSubmissionId: 'ID do Formulário Enviado',
